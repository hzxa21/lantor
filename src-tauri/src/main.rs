...
use prompts::{
    build_claude_streaming_prompt, build_streaming_work_item_prompt, build_work_item_prompt,
...
use runtime::process::{
    classify_agent_output_activity, configure_agent_context_tool_env, configure_agent_identity_env,
    effective_launch_command, pipe_run_output, terminate_process_group, truncate_activity_detail,
    upsert_runtime_thread_id, wait_for_agent_run,
};
#[cfg(test)]
use runtime::streaming::maybe_hide_silent_streaming_reply;
use runtime::streaming::{
    append_streaming_agent_message, consume_streaming_agent_control_lines,
    ensure_streaming_agent_message, finish_streaming_agent_message, mark_run_work_item_silent,
    streaming_message_exists,
};
use runtime::surface::{
    append_claude_thread_context, claude_surface_boundary_marker, same_codex_surface,
    ClaudeSurface, CodexActiveTurnScheduleState,
};
...
#[cfg(test)]
mod tests {
    use crate::prompts::build_codex_streaming_prompt;
    use crate::runtime::{
        process::load_runtime_thread_id,
        streaming::{adopt_streaming_agent_message_key, streaming_message_body_is_empty},
    };

    use super::{
        activity_status, append_claude_thread_context, append_streaming_agent_message,
        ...
        load_reminders, mark_all_owner_inbox_read_in_pool, mark_inbox_items_read_in_pool,
        ...
        upsert_runtime_thread_id, AgentAttachmentFile, AgentEvent, AgentInboxItemInput,
        ClaudeSurface, InboxWakeItem, InboxWakeSummary, MentionDispatchOrigin,

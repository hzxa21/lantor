...
const LOCAL_SLOCK_CONTROL_EVENTS = [
  ...
  '{"type":"artifact_create","channel_id":"uuid","thread_root_id":"optional uuid","kind":"markdown|json|table|chart|diff|html|text","title":"Report","summary":"Short chat summary","content":"Full artifact content","metadata":{}}',
